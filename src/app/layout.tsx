...
export const metadata: Metadata = {
  ...
  description: "Plataforma de gestión de transporte, cargas y logística en tiempo real de EL CASAL",
};
  ...
  return (
    <html lang="es">
      ...
      <body style={{ paddingTop: '65px' }}>
        <ThemeSwitcher />
        <RefreshButton />
        {/* Barra Superior Fija de WhatsApp */}
        <a
          href="https://wa.me/541150443328"
          target="_blank"
